...
<head>
 ...
 '><!--Esto es para ayudar a los padres y a las escuelas a controlar los lugares a los
  ...
  <title>PHP Arrays | Solumobil</title>
</head>
<body>
...
<div class="page-container">
    ...
    <ul class="list-unstyled full-reset navigation-list">
      ...
      <div class="dropdown-menu dropdown-toggle">
          <a id="i1" class="dropdown-item" href="../PHP_Parte_1/PHP_Parte_1.php">PHP | Parte 1</a>
          <a id="i1" class="dropdown-item" href="PHP_Parte_2.php">PHP | Parte 2</a>
...
<div class="puntos">
  <main>
    <header>
			<h4>Ejercicios de matrices o arreglos en PHP</h4><nav id="nave">
	<ul class="lista-puntos"><li><a href="ejercicio_1/ejercicio_1.php">Punto 1</a></li><ul>
	<ul class="lista-puntos"><li><a href="#" title="Proximamente">Punto 2</a></li></ul>
			</nav>
		</header>
	</main>
</div>
